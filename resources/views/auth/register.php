        ...
        <div class="card">
            <div class="card-body">
                <div class=" text-center">
                    <p>Create your Account to start session!</p>
                </div>
                <form action="/register" method="POST">
                    <div class="form-group">
                        <input class="form-control <?= isset($errors['fullname']) ? 'is-invalid' : '' ?>" type="text" name="fullname" value="<?= htmlspecialchars($input['fullname'] ?? '') ?>" placeholder=" ">
                    ...
                    <div class="form-group">
                        <input class="form-control <?= isset($errors['confirm_password']) ? 'is-invalid' : '' ?>" type="password" name="confirm_password" value="<?= htmlspecialchars($input['confirm_password'] ?? '') ?>" placeholder=" ">
                        <label>Confirm Password</label>
                        <?php if (isset($errors['confirm_password'])) : ?>
                            <div class="invalid-feedback">
                                <?= htmlspecialchars($errors['confirm_password'][0]) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
